"""
Listing model -- tracks active NFT listings across marketplaces.
"""
...
class Listing(Base):
    ...
    currency = Column(String(20), nullable=True, default="ETH")
    ...
    def __repr__(self):
        return (
            f"<Listing token={self.token_id} marketplace={self.marketplace!r} "
            f"price={self.price}>"
        )
